...
function isIE () {
	// This function is used to detect if the program is loaded on Internet Explorer Browser
...
function toggleVolumeRocker () {
	if (volume_btn.className.indexOf('show-volume') !== -1) {
		hideVolumeRocker();
	}else {
		showVolumeRocker();
	}
